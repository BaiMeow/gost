...
func (h *tuntunnelHandler) handleClient(ctx context.Context, conn net.Conn, raddr string, config *tun.Config, log logger.Logger) error {
	var ips []net.IP
...
func (h *tuntunnelHandler) keepalive(ctx context.Context, conn net.Conn, ips []net.IP) {
	// handshake
...
func (h *tuntunnelHandler) transportClient(tun io.ReadWriter, conn net.Conn, log logger.Logger) error {
